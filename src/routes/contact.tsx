    ...
    <PageShell transparentNav>
      ...
      <section className="px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_1.3fr]">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-terracotta">Reach out</p>
            ...
            <div className="mt-10 space-y-5">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-ink/50">Address</p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-ink/50">Phone</p>
                  <p className="mt-1 text-sm text-ink/80">Details coming soon</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10">
              <p className="text-xs uppercase tracking-[0.2em] text-ink/50">Follow</p>
              <Socials className="mt-3 text-ink/70" />
            </div>
          </div>

          <form
            className="rounded-2xl border border-border/60 bg-card p-6 shadow-sm sm:p-10"
            onSubmit={(e) => {
              e.preventDefault();
              setSent(true);
          ...
          >
            ...
            <div className="mt-5">
              <label className="block text-xs uppercase tracking-[0.2em] text-ink/60">Message</label>
              <textarea
                name="message"
                required
                rows={6}
            ...
            <button
              type="submit"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-terracotta px-8 py-3.5 text-sm font-medium uppercase tracking-[0.2em] text-ivory transition-opacity hover:opacity-90"
            >
              Send message
